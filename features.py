...
class VPINCalculator:
    def __init__(
        self,
        bucket_volume: float,
        history: int = 180,               # ✅ 1일 버킷 갯수/4 
        bucket_ttl_seconds: int = 3 * 60,   # ✅ 기본 3분
    ):
...
def compute_trade_count_spike(klines_1m: pd.DataFrame, window: int = 120) -> dict:
    """
...
class OFIBestLevelCalculator:
    ...
    def __init__(self, window_minutes: int = 2, z_window: int = 30):
